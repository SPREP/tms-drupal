...
## ci	:	Start up containers.
.PHONY: ci
ci:
	@echo "Starting up ci containers for $(PROJECT_NAME)..."
	docker-compose -f docker-compose.yml -f docker-compose.test.yml up -d --remove-orphans
	
## gitpod	:	Start up containers.
.PHONY: gitpod
gitpod:
	@echo "Starting up gitpod containers for $(PROJECT_NAME)..."
	docker-compose -f docker-compose.yml -f docker-compose.gitpod.yml --env-file .env.gitpod up -d --remove-orphans
